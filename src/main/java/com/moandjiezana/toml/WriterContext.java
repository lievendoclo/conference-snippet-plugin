...
class WriterContext {
  ...
  WriterContext(IndentationPolicy indentationPolicy, com.moandjiezana.toml.DatePolicy datePolicy, Writer output) {
  ...
  private WriterContext(String key, String tableIndent, Writer output, IndentationPolicy indentationPolicy, com.moandjiezana.toml.DatePolicy datePolicy) {
    this.key = key;
    this.output = output;
