...
class ValueWriters {
  ...
  private static com.moandjiezana.toml.DateValueReaderWriter getPlatformSpecificDateConverter() {
  ...
  private static final ValueWriter[] VALUE_WRITERS = {
      StringValueReaderWriter.STRING_VALUE_READER_WRITER, NUMBER_VALUE_READER_WRITER, BOOLEAN_VALUE_READER_WRITER, getPlatformSpecificDateConverter(),
      MAP_VALUE_WRITER, PrimitiveArrayValueWriter.PRIMITIVE_ARRAY_VALUE_WRITER, TABLE_ARRAY_VALUE_WRITER
  };
}
