...
class ObjectValueWriter implements com.moandjiezana.toml.ValueWriter {
  static final com.moandjiezana.toml.ValueWriter OBJECT_VALUE_WRITER = new ObjectValueWriter();
