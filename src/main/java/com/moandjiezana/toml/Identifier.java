...
class Identifier {
  ...
  static Identifier from(String name, com.moandjiezana.toml.Context context) {
    Type type;
    boolean valid;
    name = name.trim();
    if (name.startsWith("[[")) {
  ...
  private static boolean isValidKey(String name, com.moandjiezana.toml.Context context) {
  ...
  private static boolean isValidTable(String name, com.moandjiezana.toml.Context context) {
    boolean valid = true;
    ...
    for (int i = 0; i < trimmed.length(); i++) {
      ...
      if (com.moandjiezana.toml.Keys.isQuote(c)) {
        if (!quoteAllowed) {
          valid = false;
  ...
  private static boolean isValidTableArray(String line, com.moandjiezana.toml.Context context) {
    boolean valid = true;
