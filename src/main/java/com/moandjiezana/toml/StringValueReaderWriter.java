...
class StringValueReaderWriter implements com.moandjiezana.toml.ValueReader, com.moandjiezana.toml.ValueWriter {
  ...
  @Override
  public Object read(String s, AtomicInteger index, com.moandjiezana.toml.Context context) {
  ...
  @Override
  public void write(Object value, com.moandjiezana.toml.WriterContext context) {
    context.write('"');
  ...
  private void escapeUnicode(String in, com.moandjiezana.toml.WriterContext context) {
