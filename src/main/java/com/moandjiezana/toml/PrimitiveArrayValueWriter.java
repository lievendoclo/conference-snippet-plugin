...
class PrimitiveArrayValueWriter extends com.moandjiezana.toml.ArrayValueWriter {
  static final com.moandjiezana.toml.ValueWriter PRIMITIVE_ARRAY_VALUE_WRITER = new PrimitiveArrayValueWriter();
  ...
  public void write(Object o, com.moandjiezana.toml.WriterContext context) {
    ...
    boolean first = true;
    com.moandjiezana.toml.ValueWriter firstWriter = null;
    ...
    for (Object value : values) {
      if (first) {
        ...
        com.moandjiezana.toml.ValueWriter writer = WRITERS.findWriterFor(value);
